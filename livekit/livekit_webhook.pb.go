...
type WebhookEvent struct {
	...
	DequeuedAt int64 `protobuf:"varint,12,opt,name=dequeued_at,json=dequeuedAt,proto3" json:"dequeued_at,omitempty"`
...
func (x *WebhookEvent) GetDequeuedAt() int64 {
	if x != nil {
		return x.DequeuedAt
	}
	return 0
...
type BatchedWebhookEvents struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Events     []*WebhookEvent `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
	NumDropped int32           `protobuf:"varint,2,opt,name=num_dropped,json=numDropped,proto3" json:"num_dropped,omitempty"`
	DequeuedAt int64           `protobuf:"varint,3,opt,name=dequeued_at,json=dequeuedAt,proto3" json:"dequeued_at,omitempty"`
}

func (x *BatchedWebhookEvents) Reset() {
	*x = BatchedWebhookEvents{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchedWebhookEvents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchedWebhookEvents) ProtoMessage() {}

func (x *BatchedWebhookEvents) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_webhook_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchedWebhookEvents.ProtoReflect.Descriptor instead.
func (*BatchedWebhookEvents) Descriptor() ([]byte, []int) {
	return file_livekit_webhook_proto_rawDescGZIP(), []int{1}
}

func (x *BatchedWebhookEvents) GetEvents() []*WebhookEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *BatchedWebhookEvents) GetNumDropped() int32 {
	if x != nil {
		return x.NumDropped
	}
	return 0
...
func (x *BatchedWebhookEvents) GetDequeuedAt() int64 {
	if x != nil {
		return x.DequeuedAt
	}
	return 0
...
var file_livekit_webhook_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x03, 0x0a, 0x0c, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x45,
	...
	,
...
var file_livekit_webhook_proto_goTypes = []interface{}{
	...
	(*BatchedWebhookEvents)(nil), // 1: livekit.BatchedWebhookEvents
...
var file_livekit_webhook_proto_depIdxs = []int32{
	...
	0, // 5: livekit.BatchedWebhookEvents.events:type_name -> livekit.WebhookEvent
...
func file_livekit_webhook_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_webhook_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchedWebhookEvents); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
